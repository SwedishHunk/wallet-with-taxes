export const ERROR_MESSAGES = {
  ...
  RPC_UNAVAILABLE: 'Blockchain service is temporarily unavailable. Please try again later.',
  ...
  // Server & Internal
  MISSING_ENV_VAR: (varName: string) => `Missing required configuration: ${varName}`,
  ENCRYPTION_ERROR: 'An encryption error occurred. Please try again.',
  DATABASE_ERROR: 'A database error occurred. Please try again later.',
  INTERNAL_SERVER_ERROR: 'An unexpected error occurred. Please try again later.',

  // Validation
  VALIDATION_ERROR: (field: string) => `Invalid ${field}. Please check and try again.`,
