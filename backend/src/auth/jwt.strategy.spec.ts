...
describe("JwtStrategy", () => {
  ...
  it("throws when JWT_SECRET is missing", () => {
    delete process.env.JWT_SECRET;
    expect(() => new JwtStrategy(mockUserRepo as never, mockSuspensionCache as never)).toThrow(
  ...
  it("maps payload fields in validate when user is active", async () => {
    ...
    const strategy = new JwtStrategy(mockUserRepo as never, mockSuspensionCache as never);
