...
const translations = {
  ...
  "player.portfolio.inGameWallet":   { en: "In-Game Wallet", sv: "Spelplånbok" },
  "player.portfolio.gameBalance":    { en: "Balance", sv: "Saldo" },
  "player.portfolio.inGameTokens":   { en: "in-game tokens", sv: "spelvaluta" },
  "player.portfolio.withdraw":       { en: "Withdraw", sv: "Ta ut" },
  "player.portfolio.withdrawSuccess":{ en: "Withdrawn successfully", sv: "Uttag genomfört" },
  "player.portfolio.sendTokens":     { en: "Send tokens to another player", sv: "Skicka tokens till en annan spelare" },
  "player.portfolio.send":           { en: "Send", sv: "Skicka" },
  "player.portfolio.sendSuccess":    { en: "Sent successfully", sv: "Skickat" },
  "player.portfolio.amountPlaceholder": { en: "Amount", sv: "Belopp" },
  "player.portfolio.recipientPlaceholder": { en: "Recipient wallet address", sv: "Mottagarens plånboksadress" },
  "player.portfolio.sendNFT":        { en: "Send NFT", sv: "Skicka NFT" },
  "player.portfolio.confirmSend":    { en: "Confirm Send", sv: "Bekräfta sändning" },
  "player.portfolio.cancel":         { en: "Cancel", sv: "Avbryt" },
  "player.portfolio.nftSent":        { en: "NFT sent!", sv: "NFT skickad!" },
